...
# Switches
set_property PACKAGE_PIN V17 [get_ports {rpm}]
set_property IOSTANDARD LVCMOS33 [get_ports {rpm}]
...
set_property PACKAGE_PIN R2 [get_ports {test_mode}]
set_property IOSTANDARD LVCMOS33 [get_ports {test_mode}]


# LEDs
set_property PACKAGE_PIN U16 [get_ports {rpm_led}]
set_property IOSTANDARD LVCMOS33 [get_ports {rpm_led}]
...
set_property PACKAGE_PIN L1 [get_ports {test_mode_led}]
set_property IOSTANDARD LVCMOS33 [get_ports {test_mode_led}]
...
set_property PACKAGE_PIN J1 [get_ports {sensor}]
